...
<body> 
    <div class="container"> 
        <div class="page_border"> 
            ...
            <form id="employee_registration_save" class="a-form" action="wb2.php" method="post" width='840'> 
            ...
            $.ajax({
                ...
                success: function(result){
                    if(result.ok){
                        ...
                        alert('Error encountered while trying to upload picture');
                    }
                }
            });
            return false;   
